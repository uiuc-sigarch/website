...
2. *Why is it important?*
   ...
   The field of computer architecture is extremely fast moving and
   affects nearly every field since computers are so widespread.
   Making a Python application 5% faster means you made a Python
   application 5% faster --- making a CPU 2% faster means /everything/

4. *I'm interested in computer architecture, where should I start learning?*
   ...
   2. *Self-study:* There are two parallel tracks to follow: learning
      ...
      1. *Theory:* Here are some book recommendations:
      ...
      2. *Projects/Implementation:* Resources here are a bit more scarce:
         ...
         provide hardware (FPGAs) and guidance, and you get to
